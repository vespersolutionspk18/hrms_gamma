...
def make_bank_entry(dt, dn):
	...
	je.append(
		"accounts",
		{
			...
			"cost_center": verp.get_default_cost_center(expense_claim.company),
...
def get_expense_claim_account_and_cost_center(expense_claim_type, company):
	...
	cost_center = verp.get_default_cost_center(company)
...
def update_outstanding_amount_in_payment_entry(expense_claim: dict, pe_reference: str):
	...
	# TODO: refactor convoluted code after verp payment entry becomes extensible
