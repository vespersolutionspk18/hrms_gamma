...
from hrms.subscription_utils import update_verp_access
...
def get_custom_fields():
	"""HR specific custom fields that need to be added to the masters in VERP"""
	return {
		"Company": [
			{
...
def get_post_install_patches():
	return (
		"verp.patches.v13_0.move_tax_slabs_from_payroll_period_to_income_tax_slab",
		"verp.patches.v13_0.move_doctype_reports_and_notification_from_hr_to_payroll",
		"verp.patches.v13_0.move_payroll_setting_separately_from_hr_settings",
		...
		"verp.patches.v13_0.rename_stop_to_send_birthday_reminders",
		"verp.patches.v13_0.set_training_event_attendance",
		"verp.patches.v14_0.set_payroll_cost_centers",
		"verp.patches.v13_0.update_employee_advance_status",
		"verp.patches.v13_0.update_expense_claim_status_for_paid_advances",
		"verp.patches.v14_0.delete_employee_transfer_property_doctype",
		"verp.patches.v13_0.set_payroll_entry_status",
		# HRMS
