...
from verp.setup.doctype.department.department import get_abbreviated_name
from verp.setup.doctype.designation.test_designation import create_designation
from verp.setup.utils import enable_all_roles_and_domains
